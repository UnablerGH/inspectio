...
hospitacje_bp = Blueprint('hospitacje', __name__)

@hospitacje_bp.route('/api/hospitacje/<int:id_pracownika>', methods=['GET'])
def get_hospitacje(id_pracownika):
    return jsonify(get_hospitacje_pracownika(id_pracownika))

@hospitacje_bp.route('/api/hospitacja/<int:id_hospitacji>', methods=['GET'])
...
@hospitacje_bp.route('/api/hospitacja/<int:id_hospitacji>/zaakceptuj', methods=['POST'])
